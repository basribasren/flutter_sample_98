import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import '../models/sliderrectangle1314_item_model.dart';import '../models/in_appgifting_item_model.dart';import 'package:basri_s_application9/presentation/in_app_gifting_screen/models/in_app_gifting_model.dart';part 'in_app_gifting_event.dart';part 'in_app_gifting_state.dart';class InAppGiftingBloc extends Bloc<InAppGiftingEvent, InAppGiftingState> {InAppGiftingBloc(InAppGiftingState initialState) : super(initialState) { on<InAppGiftingInitialEvent>(_onInitialize); }

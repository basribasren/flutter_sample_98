import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import '../models/teambuilder_item_model.dart';import 'package:basri_s_application9/presentation/team_builder_screen/models/team_builder_model.dart';part 'team_builder_event.dart';part 'team_builder_state.dart';class TeamBuilderBloc extends Bloc<TeamBuilderEvent, TeamBuilderState> {TeamBuilderBloc(TeamBuilderState initialState) : super(initialState) { on<TeamBuilderInitialEvent>(_onInitialize); }

import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import '../models/sms_item_model.dart';import 'package:basri_s_application9/presentation/sms_screen/models/sms_model.dart';part 'sms_event.dart';part 'sms_state.dart';class SmsBloc extends Bloc<SmsEvent, SmsState> {SmsBloc(SmsState initialState) : super(initialState) { on<SmsInitialEvent>(_onInitialize); }

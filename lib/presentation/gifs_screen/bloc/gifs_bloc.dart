import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import 'package:basri_s_application9/presentation/gifs_screen/models/gifs_model.dart';part 'gifs_event.dart';part 'gifs_state.dart';class GifsBloc extends Bloc<GifsEvent, GifsState> {GifsBloc(GifsState initialState) : super(initialState) { on<GifsInitialEvent>(_onInitialize); on<ChangeSwitchEvent>(_changeSwitch); }

import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import '../models/uploadmedia_item_model.dart';import 'package:basri_s_application9/presentation/upload_media_screen/models/upload_media_model.dart';part 'upload_media_event.dart';part 'upload_media_state.dart';class UploadMediaBloc extends Bloc<UploadMediaEvent, UploadMediaState> {UploadMediaBloc(UploadMediaState initialState) : super(initialState) { on<UploadMediaInitialEvent>(_onInitialize); }

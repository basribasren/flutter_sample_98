...
import 'package:basri_s_application9/presentation/facebook_feeds_display_screen/models/facebook_feeds_display_model.dart';
...
class FacebookFeedsDisplayBloc
  ...
  _onInitialize(
    ...
    emit(state.copyWith(
      ...
      listprofileimglarge8ItemList: fillListprofileimglarge8ItemList(),
    )));
  }

  List<Listprofileimglarge8ItemModel> fillListprofileimglarge8ItemList() {
    return List.generate(2, (index) => Listprofileimglarge8ItemModel());
  }
}

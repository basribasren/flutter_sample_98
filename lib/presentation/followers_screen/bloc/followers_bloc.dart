import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import '../models/followers_item_model.dart';import 'package:basri_s_application9/presentation/followers_screen/models/followers_model.dart';part 'followers_event.dart';part 'followers_state.dart';class FollowersBloc extends Bloc<FollowersEvent, FollowersState> {FollowersBloc(FollowersState initialState) : super(initialState) { on<FollowersInitialEvent>(_onInitialize); }

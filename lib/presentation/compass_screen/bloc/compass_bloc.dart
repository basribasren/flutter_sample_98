import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import 'package:basri_s_application9/presentation/compass_screen/models/compass_model.dart';part 'compass_event.dart';part 'compass_state.dart';class CompassBloc extends Bloc<CompassEvent, CompassState> {CompassBloc(CompassState initialState) : super(initialState) { on<CompassInitialEvent>(_onInitialize); }

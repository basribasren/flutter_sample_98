import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import 'package:basri_s_application9/presentation/desktop_notification_screen/models/desktop_notification_model.dart';part 'desktop_notification_event.dart';part 'desktop_notification_state.dart';class DesktopNotificationBloc extends Bloc<DesktopNotificationEvent, DesktopNotificationState> {DesktopNotificationBloc(DesktopNotificationState initialState) : super(initialState) { on<DesktopNotificationInitialEvent>(_onInitialize); on<ChangeCheckBoxEvent>(_changeCheckBox); }

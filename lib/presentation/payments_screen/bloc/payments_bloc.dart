import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import '../models/payments_item_model.dart';import 'package:basri_s_application9/presentation/payments_screen/models/payments_model.dart';part 'payments_event.dart';part 'payments_state.dart';class PaymentsBloc extends Bloc<PaymentsEvent, PaymentsState> {PaymentsBloc(PaymentsState initialState) : super(initialState) { on<PaymentsInitialEvent>(_onInitialize); }

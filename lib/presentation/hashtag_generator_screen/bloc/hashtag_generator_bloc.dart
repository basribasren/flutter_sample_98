import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import '../models/listnaturerocksvalue_item_model.dart';import 'package:basri_s_application9/presentation/hashtag_generator_screen/models/hashtag_generator_model.dart';part 'hashtag_generator_event.dart';part 'hashtag_generator_state.dart';class HashtagGeneratorBloc extends Bloc<HashtagGeneratorEvent, HashtagGeneratorState> {HashtagGeneratorBloc(HashtagGeneratorState initialState) : super(initialState) { on<HashtagGeneratorInitialEvent>(_onInitialize); on<ChangeCheckBoxEvent>(_changeCheckBox); }
